...
import static org.openhab.binding.electric.internal.handler.price.PriceHandler.countInitialMinutes;
...
/**
 * ENTSO-E price handler unit tests.
 *
...
public class EntsoeHandlerTest {
    ...
    void countInitialMinutesAllLtResolution(int resolution) {
    ...
    @CsvSource({ "15,0,0", "15,1,14", "15,2,13", "15,14,1", "15,15,0", "15,16,14", "15,29,1", "15,30,0", "15,31,14",
            ...
            "60,59,1" })
    void countInitialMinutesAllLtResolution(int resolution, int now, int expected) {
