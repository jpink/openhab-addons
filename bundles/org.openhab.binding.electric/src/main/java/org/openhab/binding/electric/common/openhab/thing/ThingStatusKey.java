...
public interface ThingStatusKey {
    Map<ThingStatusDetail, ThingStatus> STATUS_BY_DETAIL = Map.of(COMMUNICATION_ERROR, OFFLINE, CONFIGURATION_ERROR,
            OFFLINE, CONFIGURATION_PENDING, ONLINE, BRIDGE_OFFLINE, OFFLINE, FIRMWARE_UPDATING, OFFLINE, DUTY_CYCLE,
            OFFLINE, GONE, OFFLINE);

    @Nullable
    ThingStatus getStatus();

    @Nullable
    ThingStatusDetail getStatusDetail();
