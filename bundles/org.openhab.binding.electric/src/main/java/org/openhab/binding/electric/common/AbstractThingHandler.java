...
public abstract class AbstractThingHandler<C> extends BaseThingHandler {
    public static final Map<ThingStatusDetail, ThingStatus> STATUS_BY_DETAIL = Map.of(
    ...
    protected C getConfiguration() {
        ...
        if (configuration == null) throw new IllegalStateException("Can't create " + configurationClass.getName());
