...
public class CurrencyUnit implements Unit<Money> {
    ...
    /**
     * Returns the symbol (if any) of this unit. This method returns {@code null} if this unit has no specific symbol
     * associated with.
     *
     * @return this unit symbol, or {@code null} if this unit has not specific symbol associated with (e.g. product of
     *         units).
     * @see #toString()
     * @see UnitFormat
     */
     ...
     */
    @Override
    public boolean isEquivalentTo(Unit<Money> that) {
     ...
     */
    @Override
    public UnitConverter getConverterTo(Unit<Money> that) throws UnconvertibleException {
     ...
     * METRE.multiply(KILOGRAM).divide(SECOND.pow(2)).alternate("N").asType(Force.class);<br> {@literal Unit<Pressure>}
     * PASCAL = NEWTON.divide(METRE.pow(2)).alternate("Pa").asType(Pressure.class);<br>
     * </code>
     *
     ...
     * @throws MeasurementException if the specified symbol is not valid or is already associated to a different
     *         unit.
     */
    @Override
    public Unit<Money> alternate(String symbol) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> shift(Number offset) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> shift(double offset) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> multiply(Number multiplier) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> multiply(double multiplier) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> divide(Number divisor) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> divide(double divisor) {
        return null;
    }
     ...
     */
    @Override
    public Unit<Money> transform(UnitConverter operation) {
        return null;
    }
