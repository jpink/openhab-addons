...
import org.openhab.binding.entsoe.internal.price.service.CurrencyUnit2;
...
public class PriceConfig {
    ...
    private ProductPrice price(double totalPrice, VatRate vatRate) {
        return ProductPrice.fromTotal(totalPrice, vatRate, new CurrencyUnit2(EUR, UNIT_CENT_PER_KWH.equals(unit)),
                Units.KILOWATT_HOUR);
    }
